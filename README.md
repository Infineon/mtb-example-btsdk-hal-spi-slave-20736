# HAL SPI Slave sample application
## Overview
The application initializes a second SPI interface to communicate with the
primary peer device as a SPI slave. The standard 4 SPI wires and a flow control GPIO (FCO) are used for communicating with the master.  Following is the description of the protocol.

A: Slave to master communication.
...
B: Master to slave communication.
...
# Features demonstrated
  1. Configuring SPI2 in the slave mode
  2. Send data to the master device on a timer event
  3. Receive data from the master device on the SPI interface
## Instructions
  ...
  1. Connect the Master & Slave devices toegther using breadboard wires
     ...
     Master                           Slave
      ...
      P3 (D13) ---------CLK---------  P23 (D13)
      P4 (D2)  ---------MOSI--------  P0  (D11)
      P14 (J2,2)--------FCO---------  P14 (J2,2)

  2. Plug the SPI Master eval board into your computer
  3. Build and download the SPI Master application (to the WICED board)
  ...
  4. Applications transmits and receives data to SPI interface and prints it out to the serial terminal application.
